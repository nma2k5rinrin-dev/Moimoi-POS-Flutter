class UserModel {
  ...
  factory UserModel.fromMap(Map<String, dynamic> map) {
    return UserModel(
      ...
      loginAttemptAt: map['login_attempt_at'] != null
          ? DateTime.tryParse(map['login_attempt_at'])
          : null,
    );
  }
  ...
  UserModel copyWith({
    ...
    return UserModel(
      ...
      loginAttemptAt: loginAttemptAt ?? this.loginAttemptAt,
    );
  }
}
