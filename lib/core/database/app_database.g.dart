...
class $LocalThuChiTable extends LocalThuChi
    with TableInfo<$LocalThuChiTable, LocalThuChiData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $LocalThuChiTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'local_thu_chi';
  @override
  VerificationContext validateIntegrity(
    Insertable<LocalThuChiData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  LocalThuChiData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return LocalThuChiData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $LocalThuChiTable createAlias(String alias) {
    return $LocalThuChiTable(attachedDatabase, alias);
  }
}

class LocalThuChiData extends DataClass implements Insertable<LocalThuChiData> {
  final String id;
  final String storeId;
  final String type;
  final double amount;
  ...
  LocalThuChiCompanion toCompanion(bool nullToAbsent) {
    return LocalThuChiCompanion(
      id: Value(id),
      storeId: Value(storeId),
      type: Value(type),
      amount: Value(amount),
  ...
  factory LocalThuChiData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  LocalThuChiData copyWithCompanion(LocalThuChiCompanion data) {
    return LocalThuChiData(
      id: data.id.present ? data.id.value : this.id,
      storeId: data.storeId.present ? data.storeId.value : this.storeId,
  ...
  @override
  String toString() {
    return (StringBuffer('LocalThuChiData(')
          ..write('id: $id, ')
          ..write('storeId: $storeId, ')
          ..write('type: $type, ')
          ..write('amount: $amount, ')
...
class LocalThuChiCompanion extends UpdateCompanion<LocalThuChiData> {
  final Value<String> id;
  final Value<String> storeId;
  ...
  LocalThuChiCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       amount = Value(amount),
       time = Value(time);
  static Insertable<LocalThuChiData> custom({
    Expression<String>? id,
    Expression<String>? storeId,
  ...
  @override
  String toString() {
    return (StringBuffer('LocalThuChiCompanion(')
          ..write('id: $id, ')
          ..write('storeId: $storeId, ')
          ..write('type: $type, ')
          ..write('amount: $amount, ')
...
class $LocalCategoriesTable extends LocalCategories
  ...
  @override
  List<GeneratedColumn> get $columns => [id, name, storeId, emoji, color];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class LocalCategory extends DataClass implements Insertable<LocalCategory> {
  ...
  @override
  int get hashCode => Object.hash(id, name, storeId, emoji, color);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $LocalThuChiTable localThuChi = $LocalThuChiTable(this);
...
typedef $$LocalOrdersTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$LocalThuChiTableCreateCompanionBuilder =
    LocalThuChiCompanion Function({
      required String id,
      required String storeId,
      required String type,
      required double amount,
...
typedef $$LocalThuChiTableUpdateCompanionBuilder =
    LocalThuChiCompanion Function({
      Value<String> id,
      Value<String> storeId,
      Value<String> type,
...
class $$LocalThuChiTableFilterComposer
    extends Composer<_$AppDatabase, $LocalThuChiTable> {
  $$LocalThuChiTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LocalThuChiTableOrderingComposer
    extends Composer<_$AppDatabase, $LocalThuChiTable> {
  $$LocalThuChiTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LocalThuChiTableAnnotationComposer
    extends Composer<_$AppDatabase, $LocalThuChiTable> {
  $$LocalThuChiTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LocalThuChiTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $LocalThuChiTable,
          ...
          $$LocalThuChiTableOrderingComposer,
          $$LocalThuChiTableAnnotationComposer,
          $$LocalThuChiTableCreateCompanionBuilder,
          $$LocalThuChiTableUpdateCompanionBuilder,
          (
            LocalThuChiData,
            BaseReferences<_$AppDatabase, $LocalThuChiTable, LocalThuChiData>,
          ),
          LocalThuChiData,
          PrefetchHooks Function()
        > {
  $$LocalThuChiTableTableManager(_$AppDatabase db, $LocalThuChiTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$LocalThuChiTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$LocalThuChiTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$LocalThuChiTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> storeId = const Value.absent(),
...
typedef $$LocalThuChiTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $LocalThuChiTable,
      LocalThuChiData,
...
class $AppDatabaseManager {
  ...
  $$LocalThuChiTableTableManager get localThuChi =>
      $$LocalThuChiTableTableManager(_db, _db.localThuChi);
