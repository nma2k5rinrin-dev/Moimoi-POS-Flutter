...
class _NhapThuPageState extends State<NhapThuPage> {
...
Future<void> showAddCategoryDialog({
  ...
  return showAnimatedDialog(
    ...
    builder: (ctx) => Center(
      child: _AddCategoryDialogContent(typeLabel: typeLabel, onSave: onSave),
    ),
  );
}
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Thêm loại ${widget.typeLabel} mới',
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.edit_rounded, color: AppColors.slate400, size: 16),
                ),
              ),
            ),
            const SizedBox(height: 16),
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: isSelected
                          ...
                          : null,
                      boxShadow: isSelected
                          ? [BoxShadow(color: _colors[i].withValues(alpha: 0.4),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text('Lưu loại ${widget.typeLabel} mới',
