...
class _AvatarCropDialogState extends State<_AvatarCropDialog> {
  ...
  Future<String?> _cropImage() async {
    ...
    try {
      ...
      final topLeft = _transformPoint(inverted, cropCenter - Offset(radius, radius));
      final bottomRight = _transformPoint(inverted, cropCenter + Offset(radius, radius));
      ...
      final dstRect = Rect.fromLTWH(0, 0, outSize.toDouble(), outSize.toDouble());
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: AppColors.emerald200, width: 2),
                        boxShadow: [
                          BoxShadow(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            disabledBackgroundColor:
                                AppColors.emerald500.withValues(alpha: 0.7),
