...
final List<_IconEntry> _defaultFnbIcons = [
  ...
  _IconEntry(PhosphorIconsDuotone.coffeeBean, ['coffee bean', 'hạt cà phê', 'bean']),
  _IconEntry(PhosphorIconsDuotone.teaBag, ['tea', 'trà', 'túi trà']),
  _IconEntry(PhosphorIconsDuotone.cake, ['cake', 'bánh', 'sinh nhật', 'dessert']),
  _IconEntry(PhosphorIconsDuotone.hamburger, ['hamburger', 'burger', 'bánh mì kẹp']),
  _IconEntry(PhosphorIconsDuotone.pizza, ['pizza', 'bánh pizza']),
  _IconEntry(PhosphorIconsDuotone.iceCream, ['ice cream', 'kem', 'đá']),
  _IconEntry(PhosphorIconsDuotone.bowlFood, ['bowl food', 'tô', 'bát', 'cơm', 'phở']),
  _IconEntry(PhosphorIconsDuotone.bowlSteam, ['bowl steam', 'soup', 'canh', 'nóng', 'mì']),
  _IconEntry(PhosphorIconsDuotone.cookingPot, ['cooking pot', 'nồi', 'lẩu', 'nấu']),
  _IconEntry(PhosphorIconsDuotone.forkKnife, ['fork knife', 'dao dĩa', 'ăn', 'restaurant', 'nhà hàng']),
  _IconEntry(PhosphorIconsDuotone.martini, ['martini', 'cocktail', 'rượu', 'drink']),
  _IconEntry(PhosphorIconsDuotone.wine, ['wine', 'rượu vang', 'vang']),
  _IconEntry(PhosphorIconsDuotone.beerStein, ['beer', 'bia', 'cốc bia']),
  _IconEntry(PhosphorIconsDuotone.beerBottle, ['beer bottle', 'chai bia', 'bottle']),
  _IconEntry(PhosphorIconsDuotone.bread, ['bread', 'bánh mì', 'ổ bánh']),
  _IconEntry(PhosphorIconsDuotone.cookie, ['cookie', 'bánh quy', 'snack']),
  _IconEntry(PhosphorIconsDuotone.orangeSlice, ['orange', 'cam', 'trái cây', 'fruit']),
  ...
  _IconEntry(PhosphorIconsDuotone.eggCrack, ['egg crack', 'trứng rán', 'ốp la']),
  ...
  _IconEntry(PhosphorIconsDuotone.pottedPlant, ['potted plant', 'chậu cây', 'trang trí']),
  _IconEntry(PhosphorIconsDuotone.fire, ['fire', 'lửa', 'nóng', 'hot', 'nướng', 'bbq']),
  ...
  _IconEntry(PhosphorIconsDuotone.shoppingBag, ['shopping bag', 'túi', 'mang về', 'takeaway']),
  _IconEntry(PhosphorIconsDuotone.shoppingCart, ['cart', 'giỏ hàng', 'mua']),
  _IconEntry(PhosphorIconsDuotone.basket, ['basket', 'giỏ', 'rổ']),
  _IconEntry(PhosphorIconsDuotone.callBell, ['bell', 'chuông', 'gọi', 'phục vụ']),
];
...
final List<_IconEntry> _extraIcons = [
  ...
  _IconEntry(PhosphorIconsDuotone.crown, ['crown', 'vương miện', 'premium', 'vip']),
  _IconEntry(PhosphorIconsDuotone.gift, ['gift', 'quà', 'tặng', 'khuyến mãi']),
  _IconEntry(PhosphorIconsDuotone.percent, ['percent', 'phần trăm', 'giảm giá', 'sale']),
  ...
  _IconEntry(PhosphorIconsDuotone.clock, ['clock', 'đồng hồ', 'giờ', 'thời gian']),
  _IconEntry(PhosphorIconsDuotone.timer, ['timer', 'hẹn giờ', 'bấm giờ']),
  _IconEntry(PhosphorIconsDuotone.thermometer, ['thermometer', 'nhiệt kế', 'nhiệt độ']),
  _IconEntry(PhosphorIconsDuotone.thermometerHot, ['thermometer hot', 'nóng', 'nhiệt']),
  _IconEntry(PhosphorIconsDuotone.thermometerCold, ['thermometer cold', 'lạnh', 'đá']),
  _IconEntry(PhosphorIconsDuotone.sun, ['sun', 'mặt trời', 'sáng', 'buổi sáng']),
  _IconEntry(PhosphorIconsDuotone.moon, ['moon', 'mặt trăng', 'tối', 'buổi tối']),
  _IconEntry(PhosphorIconsDuotone.moonStars, ['moon stars', 'đêm', 'sao']),
  _IconEntry(PhosphorIconsDuotone.snowflake, ['snowflake', 'tuyết', 'lạnh', 'đông']),
  ...
  _IconEntry(PhosphorIconsDuotone.palette, ['palette', 'bảng màu', 'nghệ thuật']),
  _IconEntry(PhosphorIconsDuotone.handbag, ['handbag', 'túi xách']),
  _IconEntry(PhosphorIconsDuotone.bag, ['bag', 'túi']),
  _IconEntry(PhosphorIconsDuotone.lightning, ['lightning', 'sét', 'nhanh', 'năng lượng']),
  _IconEntry(PhosphorIconsDuotone.handHeart, ['hand heart', 'tay tim', 'yêu']),
  _IconEntry(PhosphorIconsDuotone.sunglasses, ['sunglasses', 'kính mát', 'cool']),
  _IconEntry(PhosphorIconsDuotone.armchair, ['armchair', 'ghế', 'ngồi', 'sofa']),
  _IconEntry(PhosphorIconsDuotone.sprayBottle, ['spray bottle', 'bình xịt', 'vệ sinh']),
  _IconEntry(PhosphorIconsDuotone.invoice, ['invoice', 'hóa đơn', 'thanh toán']),
                        ...
                        : GridView.builder(
                            ...
                            itemBuilder: (_, i) {
                              ...
                              return GestureDetector(
                                onTap: () =>
                                    Navigator.pop(context, entry.icon),
